accounts = [{'user_id': 'jdelgado', 'password': '25','saving_bank': {'account_num': '2522345', 'amount': float(500)},'current_account':{'account_num':125,'amount':100}, 'last_trxs':(123,145,53)},
            {'user_id': 'adelgado', 'password': '24','saving_bank': {'account_num': '12341234', 'amount': float(1000)},'current_account':{'account_num':123,'amount':500}, 'last_trxs':(1235,12)} ,
            {'user_id': 'mdelgado', 'password': '22','saving_bank': {'account_num': '543253', 'amount': float(500)},'current_account':{'account_num':124,'amount':100}, 'last_trxs':(153,23423,1232,11)},
            {}]
ind = []
print('-----------------\nBanco digital LA\n-----------------')
...
while True:
    ...
    try:
        for cuenta in accounts:
            if usuario == cuenta['user_id'] and contaseña == cuenta['password']:
                logueado = True
                while logueado:
